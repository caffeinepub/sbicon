...
export interface _SERVICE {
  ...
  'getListing' : ActorMethod<[ProductID], [] | [Listing]>,
  'getListingsBySeller' : ActorMethod<[Principal], Array<Listing>>,
  'getMarketplaceWebpage' : ActorMethod<[], string>,
  'getSellerProfile' : ActorMethod<[Principal], SellerProfile>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'isSeller' : ActorMethod<[], boolean>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'updateListing' : ActorMethod<[ProductID, ListingInput], undefined>,
}
