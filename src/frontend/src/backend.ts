...
import type { Listing as _Listing, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createSellerProfile(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createSellerProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deactivateListing(arg0: ProductID): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSellers(): Promise<Array<SellerProfile>> {
        if (this.processError) {
            try {
    ...
    async getListing(arg0: ProductID): Promise<Listing | null> {
        if (this.processError) {
            try {
    ...
    async getMarketplaceWebpage(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getMarketplaceWebpage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSellerProfile(arg0: Principal): Promise<SellerProfile> {
        if (this.processError) {
            try {
    ...
    async isSeller(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isSeller();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateListing(arg0: ProductID, arg1: ListingInput): Promise<void> {
        if (this.processError) {
            try {
